...
const progmemchar m_mGHIntegral[10] PROGMEM = {'P','I','D',' ','H','G',' ','I',0x20, cTerm};
const progmemchar m_mGHProportional[10] PROGMEM = {'P','I','D',' ','H','G',' ','P',0x20, cTerm};
const progmemchar m_mGHDerivative[10] PROGMEM = {'P','I','D',' ','H','G',' ','D',0x20, cTerm};
